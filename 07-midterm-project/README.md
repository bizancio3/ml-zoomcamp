...
Enumerate files and instructions



## 1. Use case motivation
*How the solution shall be used?* \
...
*Problem statement* 
> ### Can we conclude based on these analytics whether a sample of water is safe to drink? (level of potability)
